(function ($) {
    ...
    $.fn.tautocomplete = function (options, callback) {
        ...
        var el = {
            ...
            ddTextbox: $("<input type='text' id='itmd' class='form-control' >")
        };
      ...
      /*  if (this.is(':focus')) {
        ...
        function select() {
            ...
            el.ddTextbox.data("text", selected.find('td').eq(2).text());
            ...
            el.ddTextbox.val(selected.find('td').eq(2).text());
            orginalTextBox.val(selected.find('td').eq(0).text() + '#$#' + selected.find('td').eq(2).text());
            hideDropDown();
            onChange();
            el.ddTextbox.focus();
        }
